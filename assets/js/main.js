(function ($) {
  ...
  document.querySelectorAll(".category-close i").forEach((element) => {
    element.addEventListener("click", () => {
      document
        .querySelectorAll(".category-sidebar-wrapper")
        .forEach((element) => element.classList.remove("category-active"));
    });
  });
  ...
  document.querySelectorAll(".search-icon i").forEach((element) => {
    element.addEventListener("click", () => {
      document
        .querySelectorAll(".main-searchbar")
        .forEach((element) => element.classList.add("searchbar-active"));
    });
  });
  document.querySelectorAll(".search-close i").forEach((element) => {
    element.addEventListener("click", () => {
      document
        .querySelectorAll(".main-searchbar")
        .forEach((element) => element.classList.remove("searchbar-active"));
    });
  });
...
const navlink = document.querySelectorAll('.dash-menu a').forEach(link =>{
